...
def mock_setup():
    ...
    with patch("quantmsio.core.diann.DuckDB.__init__") as mock_duckdb, patch.object(
        DiaNNConvert, "get_report_from_database"
    ) as mock_query, patch.object(DiaNNConvert, "get_masses_and_modifications_map") as mock_masses, patch.object(
        DiaNNConvert, "add_additional_msg"
    ) as mock_add_msg:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            yield {"diann": diann, "temp_dir": temp_dir, "sample_report": sample_report, "mock_add_msg": mock_add_msg}
