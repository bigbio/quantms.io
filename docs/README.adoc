...
The `DIA-NN` scan is a string that contains the scan number of the MS2 used to identified the peptide. We use the `rt_start` field and the mzML information to get that number.
