...
class TestTools(TestCase):
    ...
    def test_attach_file_to_project_json(self):
        rigister_files = [
            [__package__ + path for path in ['/examples/output/DDA-plex/MSV000079033-6771dd93-aafd-4530-882c-e98243f53aaf.feature.parquet','feature_file']],
            [__package__ + path for path in ['/examples/output/DDA-plex/MSV000079033-a645fef2-3d54-4166-88a1-519c3be3b817.psm.parquet','psm_file']],
        ]
    ...
    def test_get_unanimous(self):
        ...
        map_protein_for_parquet(parquet_path,fasta_path,output_path,map_parameter='map_protein_name',label='feature')
