...
from quantms_io.core.tools import map_protein_for_tsv
...
@labels.command("convert-accession", short_help="Map reported proteins to uniprot names/accessions in fasta file")
