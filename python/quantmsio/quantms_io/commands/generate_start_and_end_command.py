...
@click.command("inject_start_and_end_from_fasta", short_help="inject start and end to feature or psm",)
...
@click.pass_context
def inject_start_and_end_from_fasta(ctx, parquet_path:str,fasta_path:str,label:str,output_path:str):
    """
    ...
    :return: none
    """
    generate_start_and_end_from_fasta(parquet_path=parquet_path,fasta_path=fasta_path,label=label,output_path=output_path)
