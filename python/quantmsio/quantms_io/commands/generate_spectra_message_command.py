...
@click.command("map-spectrum-message-to-parquet", short_help="According mzMl to map the spectrum message to parquet"
)
...
def map_spectrum_message_to_parquet(parquet_path: str, mzml_directory: str,output_path:str,label:str,chunksize,partition:str=None):
    """
