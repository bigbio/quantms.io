...
@plot.command("plot-kde-intensity-distribution", short_help="plot kde intensity distribution of feature")
...
@plot.command("plot-bar-peptide-distribution", short_help="plot bar peptide distribution of feature")
@click.option("--feature_path", help="feature file path", required=True)
@click.option("--save_path", help="img save path [xxx.svg]", required=True)
...
@plot.command("plot-box-intensity-distribution", short_help="plot box intensity distribution of feature")
@click.option("--feature_path", help="feature file path", required=True)
@click.option("--save_path", help="img save path [xxx.svg]", required=True)
@click.option("--num_samples", help="The number of samples plotted", default=10)
@click.pass_context
