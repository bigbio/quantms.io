...
class Parquet:
    ...
    def inject_gene_msg(
        self, df: pd.DataFrame, fasta: str, map_parameter: str = "map_protein_accession", species: str = "human"
    ):
        """
        :params df: parquet file
    ...
    def generate_spectrum_msg(
        self, mzml_directory: str, output_path: str, label: str, partition: str = None, file_num: int = 2
    ):
        """
